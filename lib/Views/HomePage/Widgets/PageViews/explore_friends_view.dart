...
Widget exploreFriendsPageView() {
  return ChangeNotifierProvider<UserController>(
    create: (context) => UserController()..listenToUsers(),
                ...
                child: controller.filteredUsers.isEmpty
                    ...
                    : GridView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          bool requestSent = controller.sentRequests.contains(user);

                          // Subtle pastel color variations for profile background
                                ...
                                children: [
                                  ...
                                  ElevatedButton(
                                    onPressed: requestSent
                                        ? null // Disable button if already sent
                                        : () {
                                            controller.sendConnectionRequest(user);
                                          },
                                    style: ElevatedButton.styleFrom(
                                      backgroundColor:
                                          requestSent ? Colors.grey : Colors.cyan,
                                      shape: RoundedRectangleBorder(
                                        borderRadius: BorderRadius.circular(12),
                                      ),
                                    ),
                                    child: Text(
                                      requestSent ? "Connection Sent" : "Connect",
                                      style: TextStyle(
                                        fontSize: 14.sp,
                                        color: Colors.white,
                                      ),
