...
class ApplicationFeaturesPage extends StatefulWidget {
  const ApplicationFeaturesPage({super.key});

  @override
  _ApplicationFeaturesPageState createState() =>
      _ApplicationFeaturesPageState();
}

class _ApplicationFeaturesPageState extends State<ApplicationFeaturesPage> {
  @override
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child:
          Consumer<ApplicationFeaturesController>(builder: (context, value, _) {
        return Scaffold(
          body: IntroductionScreen(
            ...
            pages: [
              PageViewModel(
                ...
                titleWidget: Center(
                  child: Text("Welcome to VocalLens", style: titleTextStyle()),
                ),
                bodyWidget: Center(
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text("Discover how to make the most of our app",
                          style: bodyTextStyle()),
                    ],
                  ),
                ),
              ...
              PageViewModel(
                ...
                titleWidget: Center(
                  child: Text("Chat and Interact with AI",
                ...
                bodyWidget: Column(
                  ...
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Text("Engage in seamless conversations with AI,",
                        style: bodyTextStyle()),
                    Text("and receive spoken responses instantly.",
                        style: bodyTextStyle()),
                  ],
                ),
                decoration: pageDecoration,
              ...
              PageViewModel(
                ...
                titleWidget: Center(
                  child:
                      Text("Seamless Video Streaming", style: titleTextStyle()),
                ),
                bodyWidget: Column(
                  children: [
                    Text("Discover how to watch your favorite",
                        style: bodyTextStyle()),
                    Text("YouTube videos directly on VocalLens!",
                        style: bodyTextStyle()),
                  ],
                ),
                decoration: pageDecoration,
              ...
              PageViewModel(
                ...
                titleWidget: Center(
                  child: Text("Explore New Friends", style: titleTextStyle()),
                ),
                bodyWidget: Column(
                  children: [
                    Text("Discover and connect with new friends on",
                        style: bodyTextStyle()),
                    Text("VocalLens, just like on social media!",
                        style: bodyTextStyle()),
                  ],
                ),
                decoration: pageDecoration,
              ...
              PageViewModel(
                ...
                bodyWidget: Column(
                  children: [
                    Text("Control the app effortlessly with minimal",
                        style: bodyTextStyle()),
